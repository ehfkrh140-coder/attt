...
- PR title: Phase 2A.6-OP: add operator guide, manual checklist, deterministic sample bundle, and tests
...
- Phase 2A.6-USR — User-supplied sanitized localhost artifact dry-run review, if a reviewer provides sanitized localhost artifacts.
