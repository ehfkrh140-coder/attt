...
Phase 2A.6-OP adds operator guidance and deterministic sample-bundle validation.
It is review-only and does not change execution permissions.
...
Sample bundle manifest review | Supported / Review-only | Uses existing live artifact bundle reviewer
Current PR review packet | Supported | Verified by Codex review packet verifier
