...
def mock_target(scope_confirmed: bool = True) -> TargetProtocolSpec:
    return TargetProtocolSpec(
        ...
        in_scope_contracts=[
            {"name": "MockVault", "address": "mock://vault"},
            {"name": "MockOracle", "address": "mock://oracle"},
            {"name": "MockDexPool", "address": "mock://pool"},
            {"name": "MockCircuitBreaker", "address": "mock://circuit-breaker"},
        ],
